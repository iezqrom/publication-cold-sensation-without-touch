...
# %%
name_file = "sdt_trial67_pos8"

path = "../.."
folder_name = "19042021_1"
dat_im = ReAnRaw(f"{path}/data/test_{folder_name}/videos/{name_file}")
dat_im.datatoDic()
# %%
...
plt.tight_layout()
plt.savefig(
    f"{path}/figures/methods_paper_mol/final/MOL_example.png",
    transparent=True,
)
...
plt.savefig(
    f"{path}/figures/methods_paper_mol/final/thermal_image.png",
    transparent=True,
)
