...
if __name__ == "__main__":
    try:
        ...
        printme("We are about to start method of limits")
        ...
        if situ == "ex":
            ...
            final_order = exp_rand(init_rep, check_linear, restart=100)
        ...
        for i, p in enumerate(final_order):
            ...
            name_video = f"mol_trial{i+1}_pos{str(p)}"
