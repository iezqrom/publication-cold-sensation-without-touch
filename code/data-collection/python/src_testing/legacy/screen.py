...
if __name__ == "__main__":
    ...
    for kframe, vframe in globals.frames.items():
        globals.frames[kframe] = [
            Frame(win, width=width, height=height, name="{}".format(kframe))
        ]
    ...
    def raise_frame(frame):
        ...
        try:
            if (
                ...
                or frame == globals.frames["intro_big_three"][0]
                or frame == globals.frames["intro_training"][0]
                or frame == globals.frames["intro_trials"][0]
                or frame == globals.frames["intro_tactile_height"][0]
            ):
                ...
                if check(globals.frames) == None:
                    ...
                    frame.after(
                        frame_time, lambda: raise_frame(check(globals.frames))
                    )  # frame.after(frame_time,lambda:
    ...
    label_response1 = Label(
        globals.frames["response"][0],
        text="Did it feel cold? (y/n)",
        bg="black",
        fg="white",
        font="none 30 bold",
        anchor=CENTER,
    ...
    entry_response["validatecommand"] = (
        entry_response.register(testValResponse),
        "%P",
        "%d",
    )
    ...
    label_base1 = Label(
        globals.frames["baseline_temp"][0],
        text="What is the baseline temperature? ",
        bg="black",
        fg="white",
        font="none 30 bold",
    )
    ...
    label_position_non_tactile_experimental = Label(
        big_three,
        text="Non-tactile experimental- X:     Y:     Z: ",
        bg="black",
        fg="white",
        font="none 12",
        justify=LEFT,
    ...
    label_position_non_tactile_control = Label(
        big_three,
        text="Non-tactile control- X:     Y:     Z: ",
        bg="black",
        fg="white",
        font="none 12",
        justify=LEFT,
    ...
    label_ROI_experimental = Label(
        big_three,
        text="ROI experimental- X:     Y: ",
        bg="black",
        fg="white",
        font="none 12",
        justify=LEFT,
    ...
    label_ROI_control = Label(
        big_three,
        text="ROI control- X:     Y: ",
        bg="black",
        fg="white",
        font="none 12",
        justify=LEFT,
    ...
    def showPosExp(event):
        if globals.frames["zabering"][1] == "on":
            if globals.current_device == "colther":
                ...
                label_position_non_tactile_experimental.config(
                    text="Non-tactile experimental-X: "
                    + str(globals.positions["non_tactile"]["experimental"][0])
                    + " Y: "
                    + str(globals.positions["non_tactile"]["experimental"][1])
                    + " Z: "
                    + str(globals.positions["non_tactile"]["experimental"][2])
                )
    ...
    def showPosCon(event):
        if globals.frames["zabering"][1] == "on":
            if globals.current_device == "colther":
                ...
                label_position_non_tactile_control.config(
                    text="Non-tactile control-X: "
                    + str(globals.positions["non_tactile"]["control"][0])
                    + " Y: "
                    + str(globals.positions["non_tactile"]["control"][1])
                    + " Z: "
                    + str(globals.positions["non_tactile"]["control"][2])
                )
    ...
    def showROICcontrol(event):
        if globals.frames["zabering"][1] == "on":
            label_ROI_control.config(
                text="ROI control- X: "
                + str(globals.centreROI["control"][0])
                + " Y: "
                + str(globals.centreROI["control"][1])
            )
    ...
    def showROICexperimental(event):
        if globals.frames["zabering"][1] == "on":
            label_ROI_experimental.config(
                text="ROI experimental- X: "
                + str(globals.centreROI["experimental"][0])
                + " Y: "
                + str(globals.centreROI["experimental"][1])
            )
    ...
    label_tactile_height = Label(
        globals.frames["tactile_height"][0],
        textvariable=globals.pressure,
        bg="black",
        fg="white",
        font="none 30 bold",
        anchor=CENTER,
    ...
    label_instructions_double = Label(
        tactile_height,
        text=instructions_double,
        bg="black",
        fg="white",
        font="none 12",
        justify=LEFT,
    ...
    label_position_tactile_experimental_pressure = Label(
        tactile_height,
        text="Tactile experimental- X:     Y:     Z: ",
        bg="black",
        fg="white",
    ...
    label_position_tactile_control_pressure = Label(
        tactile_height,
        text="Tactile control- X:     Y:     Z: ",
        bg="black",
        fg="white",
    ...
    def showPosExpTact(event):
        if globals.frames["tactile_height"][1] == "on":
            ...
            if globals.current_device == "tactile":
                label_position_tactile_experimental_pressure.config(
                    text="Tactile experimental-X: "
                    + str(globals.positions["tactile"]["experimental"][0])
                    + " Y: "
                    + str(globals.positions["tactile"]["experimental"][1])
    ...
    def showPosConTact(event):
        if globals.frames["tactile_height"][1] == "on":
            ...
            if globals.current_device == "tactile":
                label_position_tactile_control_pressure.config(
                    text="Tactile control-X: "
                    + str(globals.positions["tactile"]["control"][0])
                    + " Y: "
                    + str(globals.positions["tactile"]["control"][1])
    ...
    label_intro_tactile_height = Label(
        globals.frames["intro_tactile_height"][0],
        text="Now, we are going to find the pressure that the tactile stimulator exerts on your skin",
        bg="black",
        fg="white",
        font="none 30 bold",
        anchor=CENTER,
    ...
    #################################  TRAINING INTRO
    ########################################################################################
    label_intro_training = Label(
        globals.frames["intro_training"][0],
        text="We are about to start the experiment, let's practice first",
        bg="black",
        fg="white",
        font="none 30 bold",
        anchor=CENTER,
    ...
    label_repeat_training1 = Label(
        globals.frames["repeat_training"][0],
        text="Are we ready to start? (y/n)",
        bg="black",
        fg="white",
        font="none 30 bold",
        anchor=CENTER,
    ...
    entry_repeat_training["validatecommand"] = (
        entry_repeat_training.register(testValRepeatTrain),
        "%P",
        "%d",
    )
    ...
    #################################  TRIALS INTRO
    ########################################################################################
    label_intro_trials = Label(
        globals.frames["intro_trials"][0],
        text="Now, we are going to start the experiment. Press enter to begin!",
        bg="black",
        fg="white",
        font="none 30 bold",
        anchor=CENTER,
